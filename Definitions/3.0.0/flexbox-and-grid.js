...
exports.twClasses = function twClasses(config) {
  ...
  for(let i = 0; i < config.scales.DEFAULT_SPACING_SCALE.length; i++) {
    gap.push(
      {
        label:         `gap-${config.scales.DEFAULT_SPACING_SCALE[i].name}`,
        detail:        `gap: ${config.scales.DEFAULT_SPACING_SCALE[i].value};`,
        documentation: `Change the gutter size in a grid layout to ${config.scales.DEFAULT_SPACING_SCALE[i].value}.`
      }
    )
  }
  ...
  for(let i = 0; i < config.scales.DEFAULT_SPACING_SCALE.length; i++) {
    gap.push(
      {
        label:         `gap-x-${config.scales.DEFAULT_SPACING_SCALE[i].name}`,
        detail:        `column-gap: ${config.scales.DEFAULT_SPACING_SCALE[i].value};`,
        documentation: `Change the gutter size between columns in grid layouts to ${config.scales.DEFAULT_SPACING_SCALE[i].value}.`
      }
    )
  }
  ...
  for(let i = 0; i < config.scales.DEFAULT_SPACING_SCALE.length; i++) {
    gap.push(
      {
        label:         `gap-y-${config.scales.DEFAULT_SPACING_SCALE[i].name}`,
        detail:        `row-gap: ${config.scales.DEFAULT_SPACING_SCALE[i].value};`,
        documentation: `Change the gutter size between rows in grid layouts to ${config.scales.DEFAULT_SPACING_SCALE[i].value}.`
      }
    )
  }
