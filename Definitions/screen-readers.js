...
let screenReaders = [
  {
    ...
    documentation:"Use to hide an element visually without hiding it from screen readers."
  },
  {
    label:"not-sr-only",
    detail:"position: static; width: auto; height: auto; padding: 0; margin: 0; overflow: visible; clip: auto; white-space: normal;",
    documentation:"Use to undo sr-only, making an element visible to sighted users as well as screen readers."
  }
];
